...
\midrule
PG family  & Action-preference (amplifies conflict) & Sequential (exposes conflict) \\
Value family & Value-prediction (suppresses conflict) & Replay-buffered (averages conflict) \\
\bottomrule
\end{tabular}}
\caption{Two mechanisms jointly determine $\kappa$ direction.}
\end{table}
